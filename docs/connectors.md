...
| [Pygeoapi connector](https://sdsadocs.readthedocs.io/en/latest/connectors.html#pygeoapi-connector-accessing-collections-via-ogc-api-interface)     | Can read collections from a [pygeoapi](https://pygeoapi.io/) instance.                                                                                                                                                                                                                            | [Source](https://github.com/52North/innovation-prize/blob/dev/search-app/server/connectors/pygeoapi_retriever.py) |
